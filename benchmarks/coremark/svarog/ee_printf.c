...
{
    volatile ee_u32 *uart_data =
        (volatile ee_u32 *)(SVAROG_UART0_BASE + SVAROG_UART_DATA_OFFSET);
    volatile ee_u32 *uart_status =
        (volatile ee_u32 *)(SVAROG_UART0_BASE + SVAROG_UART_STATUS_OFFSET);
