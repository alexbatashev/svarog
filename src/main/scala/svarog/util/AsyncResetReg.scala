...
/** This black-boxes an Async Reset (or Set) Register.
  *
  * Because Chisel doesn't support parameterized black boxes, we unfortunately
  * have to instantiate a number of these.
  *
  * We also have to hard-code the set/ reset behavior.
  *
  * Do not confuse an asynchronous reset signal with an asynchronously reset
  * reg. You should still properly synchronize your reset deassertion.
  *
  * @param d
  *   Data input
  * @param q
